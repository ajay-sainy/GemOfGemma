...
private val fontProvider = GoogleFont.Provider(
    ...
    certificates = com.gemofgemma.ui.R.array.com_google_android_gms_fonts_certs
)

private val plusJakartaSans = GoogleFont("Plus Jakarta Sans")

val GemFontFamily = FontFamily(
    Font(googleFont = plusJakartaSans, fontProvider = fontProvider, weight = FontWeight.Light),
...
val GemTypography = Typography(
    displayLarge = TextStyle(
        fontFamily = GemFontFamily,
